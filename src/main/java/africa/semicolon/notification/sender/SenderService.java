...
public class SenderService {
    ...
    public RegistrationResponse register(RegistrationRequest registrationRequest) {
        ...
        User user = new User();
        userRepository.save(modelMapper.map(user, registrationRequest));

        RegistrationResponse registrationResponse = new RegistrationResponse(registrationRequest.getEmail());
